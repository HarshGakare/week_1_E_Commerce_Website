...
const Mensoffers = () => {
  return (
    <section className="Mensoffers flex flex-col lg:flex-row mx-auto w-11/12 h-auto bg-gradient-to-r from-blue-200 via-green-200 to-yellow-200 rounded-lg my-10 shadow-lg">
      <div className="w-full lg:w-1/2 flex flex-col justify-center pl-6 lg:pl-10 space-y-4 py-6">
        ...
        >
          Step into style with our exclusive Mensoffers – where fashion meets comfort, redefining your wardrobe with elegance and trend.
        </motion.h6>
      </div>
